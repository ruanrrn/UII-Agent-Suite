...
The following packages were installed at a version different from the one pinned in `package.json` at scaffold time due to registry resolution or compatibility:
